# Contributing to Soenneker.ProductBoard.OpenApiClient
...
1. **Create an Issue**
   - If you have a new feature idea, a bug report, or any other improvement suggestion, start by creating an issue on the [Issues](https://github.com/soenneker/soenneker.productboard.openapiclient/issues) page.
...
1. **Create a Pull Request**
   - Go to the [Pull Requests](https://github.com/soenneker/soenneker.productboard.openapiclient/pulls) page of the original repository.
