...
using Soenneker.ProductBoard.OpenApiClient.Entities.Configuration;
using Soenneker.ProductBoard.OpenApiClient.Entities.Configurations;
using Soenneker.ProductBoard.OpenApiClient.Entities.Fields;
using Soenneker.ProductBoard.OpenApiClient.Entities.Item;
using Soenneker.ProductBoard.OpenApiClient.Entities.Search;
...
using System;
namespace Soenneker.ProductBoard.OpenApiClient.Entities
{
    /// <summary>
    ...
    public partial class EntitiesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.ProductBoard.OpenApiClient.Entities.Configuration.ConfigurationRequestBuilder Configuration
        {
            get => new global::Soenneker.ProductBoard.OpenApiClient.Entities.Configuration.ConfigurationRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The configurations property</summary>
        public global::Soenneker.ProductBoard.OpenApiClient.Entities.Configurations.ConfigurationsRequestBuilder Configurations
        {
            get => new global::Soenneker.ProductBoard.OpenApiClient.Entities.Configurations.ConfigurationsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The fields property</summary>
        public global::Soenneker.ProductBoard.OpenApiClient.Entities.Fields.FieldsRequestBuilder Fields
        {
            get => new global::Soenneker.ProductBoard.OpenApiClient.Entities.Fields.FieldsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The search property</summary>
        public global::Soenneker.ProductBoard.OpenApiClient.Entities.Search.SearchRequestBuilder Search
        {
            get => new global::Soenneker.ProductBoard.OpenApiClient.Entities.Search.SearchRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public global::Soenneker.ProductBoard.OpenApiClient.Entities.Item.EntitiesItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.ProductBoard.OpenApiClient.Entities.Item.EntitiesItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Entities.EntitiesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Entities.EntitiesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Entities.EntitiesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Entities.EntitiesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves a paginated list of Entities.You can filter results, sort them, and control which fields are returned.&gt; Without the `members:pii:read` scope, owner email fields are returned as `[redacted]`. Filtering by `owner[email]` requires the `members:pii:read` scope. Without the `users:pii:read` scope, user entity name and email fields are returned as `[redacted]`.Use the `type[]` query parameter to filter by one or more entity types (e.g. `type[]=feature&amp;type[]=initiative`).Use the `fields` parameter to request only the fields you need.## Filter availabilityNot all filters apply to all entity types. For example, `status` filtering is only availablefor types that have a status field (e.g. `feature`, `initiative`), and `parent[id]` only worksfor types that have a parent relationship.Use `GET /v2/entities/configurations/{type}` to check which filters are supported for a specific type.The `filters` array in the configuration response lists all available filter parameters,their exact query parameter names, and value schemas.## Limitations- Only the `AND` operator is supported when applying multiple filters. `OR`, `NOT`, or nested conditions are not supported.
        /// </summary>
