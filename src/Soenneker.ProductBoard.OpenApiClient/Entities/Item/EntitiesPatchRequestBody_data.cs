...
#nullable enable
        public global::Soenneker.ProductBoard.OpenApiClient.Models.EntityCreateOrUpdateFields? Fields { get; set; }
#nullable restore
#else
        public global::Soenneker.ProductBoard.OpenApiClient.Models.EntityCreateOrUpdateFields Fields { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Entities.Item.EntitiesPatchRequestBody_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ProductBoard.OpenApiClient.Entities.Item.EntitiesPatchRequestBody_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ProductBoard.OpenApiClient.Entities.Item.EntitiesPatchRequestBody_data();
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperation? EntityPatchOperation { get; set; }
#nullable restore
#else
            public global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperation EntityPatchOperation { get; set; }
#endif
            /// <summary>Composed type representation for type <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperationClear"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperationClear? EntityPatchOperationClear { get; set; }
#nullable restore
#else
            public global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperationClear EntityPatchOperationClear { get; set; }
#endif
            ...
            public static global::Soenneker.ProductBoard.OpenApiClient.Entities.Item.EntitiesPatchRequestBody_data.Entities CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                ...
                else if("EntityPatchOperationClear".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.EntityPatchOperationClear = new global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperationClear();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(EntityPatchOperation != null)
                {
                    return EntityPatchOperation.GetFieldDeserializers();
                }
                else if(EntityPatchOperationClear != null)
                {
                    return EntityPatchOperationClear.GetFieldDeserializers();
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(EntityPatchOperation != null)
                {
                    writer.WriteObjectValue<global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperation>(null, EntityPatchOperation);
                }
                else if(EntityPatchOperationClear != null)
                {
                    writer.WriteObjectValue<global::Soenneker.ProductBoard.OpenApiClient.Models.EntityPatchOperationClear>(null, EntityPatchOperationClear);
                }
            }
        }
    }
