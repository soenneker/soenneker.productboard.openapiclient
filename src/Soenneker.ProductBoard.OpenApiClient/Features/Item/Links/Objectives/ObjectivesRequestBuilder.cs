...
using Soenneker.ProductBoard.OpenApiClient.Features.Item.Links.Objectives.Item;
...
{
    /// <summary>
    /// Builds and executes requests for operations under \features\{id}\links\objectives
    /// </summary>
    ...
    public partial class ObjectivesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.ProductBoard.OpenApiClient.Features.Item.Links.Objectives.Item.WithObjectiveItemRequestBuilder this[Guid position]
        {
            get
            {
        ...
        public ObjectivesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/features/{id}/links/objectives", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Features.Item.Links.Objectives.ObjectivesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ObjectivesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/features/{id}/links/objectives", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Features.Item.Links.Objectives.ObjectivesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
