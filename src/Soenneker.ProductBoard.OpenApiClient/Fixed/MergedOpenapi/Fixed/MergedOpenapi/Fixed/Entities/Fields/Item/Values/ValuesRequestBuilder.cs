...
using System;
namespace Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values
{
    /// <summary>
    /// Builds and executes requests for operations under \fixed\merged-openapi\fixed\merged-openapi\fixed\entities\fields\{id}\values
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ValuesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValuesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/merged-openapi/fixed/merged-openapi/fixed/entities/fields/{id}/values{?assignedEntityType%5B%5D*,pageCursor*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValuesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/merged-openapi/fixed/merged-openapi/fixed/entities/fields/{id}/values{?assignedEntityType%5B%5D*,pageCursor*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiFixedFieldValues1"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiFixedFieldValues1?> GetAsync(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder.ValuesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiFixedFieldValues1> GetAsync(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder.ValuesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiFixedFieldValues1>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiFixedFieldValues1.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a paginated list of allowed values for select-type and status fields (SINGLE_SELECT, MULTI_SELECT, STATUS).Use this endpoint to retrieve all available options for fields with many values, or when you needto paginate through all values.For fields with fewer values (≤1000), the values are returned inline in the field response.For fields with more values, the field response contains a reference to this endpoint.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder.ValuesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder.ValuesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Fields.Item.Values.ValuesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns a paginated list of allowed values for select-type and status fields (SINGLE_SELECT, MULTI_SELECT, STATUS).Use this endpoint to retrieve all available options for fields with many values, or when you needto paginate through all values.For fields with fewer values (≤1000), the values are returned inline in the field response.For fields with more values, the field response contains a reference to this endpoint.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiFixedEntityType1[]? AssignedEntityType { get; set; }
#nullable restore
#else
            [QueryParameter("assignedEntityType%5B%5D")]
            public global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiFixedEntityType1[] AssignedEntityType { get; set; }
