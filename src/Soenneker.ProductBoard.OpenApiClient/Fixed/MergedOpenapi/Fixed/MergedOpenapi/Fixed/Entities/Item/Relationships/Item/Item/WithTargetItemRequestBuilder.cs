...
using System;
namespace Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Item.Relationships.Item.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \fixed\merged-openapi\fixed\merged-openapi\fixed\entities\{id}\relationships\{type}\{targetId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithTargetItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Item.Relationships.Item.Item.WithTargetItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTargetItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/merged-openapi/fixed/merged-openapi/fixed/entities/{id}/relationships/{type}/{targetId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Item.Relationships.Item.Item.WithTargetItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTargetItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/merged-openapi/fixed/merged-openapi/fixed/entities/{id}/relationships/{type}/{targetId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Item.Relationships.Item.Item.WithTargetItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Item.Relationships.Item.Item.WithTargetItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
