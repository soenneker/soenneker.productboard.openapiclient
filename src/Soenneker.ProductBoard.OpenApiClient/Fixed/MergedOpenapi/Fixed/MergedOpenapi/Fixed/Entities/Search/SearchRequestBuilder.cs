...
using System;
namespace Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search
{
    /// <summary>
    /// Builds and executes requests for operations under \fixed\merged-openapi\fixed\merged-openapi\fixed\entities\search
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SearchRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/merged-openapi/fixed/merged-openapi/fixed/entities/search{?pageCursor*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/merged-openapi/fixed/merged-openapi/fixed/entities/search{?pageCursor*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchPostResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchPostResponse?> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchPostRequestBody body, Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchRequestBuilder.SearchRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchPostResponse> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchPostRequestBody body, Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchRequestBuilder.SearchRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchPostResponse>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Performs a filtered search over Entities using a POST request.This endpoint supports the same filtering capabilities as `GET /v2/entities`, but allows a larger and more complex payload.It&apos;s useful when filtering by a long list of foreign key IDs or when URL length limits become a problem.## Filter availabilityNot all filters apply to all entity types. For example, `status` filtering is only availablefor types that have a status field (e.g. `feature`, `initiative`), and `parent` filtering only worksfor types that have a parent relationship.Use `GET /v2/entities/configurations/{type}` to check which filters are supported for a specific type.The `filters` array in the configuration response lists all available filter parameters,their exact query parameter names, and value schemas.&gt; Filtering by `owner[email]` requires the `members:pii:read` scope.## Limitations- Only the `AND` operator is supported when applying multiple filters. `OR`, `NOT`, or nested conditions are not supported.- You can search only within one entity type at a time.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Fixed.MergedOpenapi.Fixed.MergedOpenapi.Fixed.Entities.Search.SearchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Performs a filtered search over Entities using a POST request.This endpoint supports the same filtering capabilities as `GET /v2/entities`, but allows a larger and more complex payload.It&apos;s useful when filtering by a long list of foreign key IDs or when URL length limits become a problem.## Filter availabilityNot all filters apply to all entity types. For example, `status` filtering is only availablefor types that have a status field (e.g. `feature`, `initiative`), and `parent` filtering only worksfor types that have a parent relationship.Use `GET /v2/entities/configurations/{type}` to check which filters are supported for a specific type.The `filters` array in the configuration response lists all available filter parameters,their exact query parameter names, and value schemas.&gt; Filtering by `owner[email]` requires the `members:pii:read` scope.## Limitations- Only the `AND` operator is supported when applying multiple filters. `OR`, `NOT`, or nested conditions are not supported.- You can search only within one entity type at a time.
        /// </summary>
