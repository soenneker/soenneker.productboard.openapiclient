...
using Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.Item;
...
using System;
namespace Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks
{
    /// <summary>
    /// Builds and executes requests for operations under \fixed\webhooks
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WebhooksRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.ProductBoard.OpenApiClient.fixed.webhooks.item collection</summary>
        /// <param name="position">UUID of the webhook subscription.</param>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.Item.WithWebhookItemRequestBuilder"/></returns>
        public global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.Item.WithWebhookItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("webhookId", position);
                return new global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.Item.WithWebhookItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WebhooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/webhooks{?pageCursor*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WebhooksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/fixed/webhooks{?pageCursor*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 403 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 408 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 429 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.WebhookListResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder.WebhooksRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
                { "401", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
                { "403", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
                { "408", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
        ...
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 403 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 408 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 422 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse">When receiving a 500 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.WebhookReferenceResponse> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.WebhookCreateRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "403", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
                { "408", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
                { "422", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.ProductBoard.OpenApiClient.Models.WebhooksErrorResponse.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder.WebhooksRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder.WebhooksRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Fixed.Webhooks.WebhooksRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// &quot;Returns all webhook subscriptions for the workspace. Returns up to 100 items per page by default.Paginated using cursor-based pagination. Follow `links.next` in the response to fetch the next page.When `links.next` is `null`, you have reached the last page.**OAuth2 isolation**: OAuth2 access tokens only see subscriptions created by the same OAuth2 application.Public API access tokens see all workspace subscriptions.&quot;
        /// </summary>
