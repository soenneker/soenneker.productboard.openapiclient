...
namespace Soenneker.ProductBoard.OpenApiClient.Models
{
    ...
    public partial class CMergedOpenapiNoteCreateRelationship1 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.CMergedOpenapiNoteCreateRelationship1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ProductBoard.OpenApiClient.Models.CMergedOpenapiNoteCreateRelationship1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
            var result = new global::Soenneker.ProductBoard.OpenApiClient.Models.CMergedOpenapiNoteCreateRelationship1();
