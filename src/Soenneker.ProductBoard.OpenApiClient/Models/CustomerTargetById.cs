...
namespace Soenneker.ProductBoard.OpenApiClient.Models
{
    ...
    public partial class CustomerTargetById : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.CustomerTargetById"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ProductBoard.OpenApiClient.Models.CustomerTargetById CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ProductBoard.OpenApiClient.Models.CustomerTargetById();
        }
        /// <summary>
