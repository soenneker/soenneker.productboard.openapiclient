...
namespace Soenneker.ProductBoard.OpenApiClient.Models
{
    ...
    public partial class MergedOpenapiMergedOpenapiMergedOpenapiNotePatchOperation1_1 : IParsable
    {
        /// <summary>The operation to perform on the field.Can be one of `set`, `addItems`, `removeItems`.</summary>
        public global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiMergedOpenapiNotePatchOperation1_1_op? Op { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiMergedOpenapiNotePatchOperation1_1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiMergedOpenapiNotePatchOperation1_1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ProductBoard.OpenApiClient.Models.MergedOpenapiMergedOpenapiMergedOpenapiNotePatchOperation1_1();
        }
        /// <summary>
