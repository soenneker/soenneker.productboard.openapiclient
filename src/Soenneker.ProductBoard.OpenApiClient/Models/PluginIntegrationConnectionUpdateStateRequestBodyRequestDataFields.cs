...
namespace Soenneker.ProductBoard.OpenApiClient.Models
{
    ...
    public partial class PluginIntegrationConnectionUpdateStateRequestBodyRequestDataFields : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// </summary>
        public PluginIntegrationConnectionUpdateStateRequestBodyRequestDataFields()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.PluginIntegrationConnectionUpdateStateRequestBodyRequestDataFields"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ProductBoard.OpenApiClient.Models.PluginIntegrationConnectionUpdateStateRequestBodyRequestDataFields CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ProductBoard.OpenApiClient.Models.PluginIntegrationConnectionUpdateStateRequestBodyRequestDataFields();
        }
        /// <summary>
