...
namespace Soenneker.ProductBoard.OpenApiClient.Models
{
    ...
    public partial class TeamPatchOperationOneOf2 : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.TeamPatchOperationOneOf2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ProductBoard.OpenApiClient.Models.TeamPatchOperationOneOf2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ProductBoard.OpenApiClient.Models.TeamPatchOperationOneOf2();
        }
        /// <summary>
