...
namespace Soenneker.ProductBoard.OpenApiClient.Notes.Configurations.Item
{
    ...
    public partial class WithTypeItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.GetNoteConfiguration200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.GetNoteConfiguration200Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.GetNoteConfiguration200Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Models.GetNoteConfiguration200Response>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Models.GetNoteConfiguration200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns configuration metadata for a specific note type, including supported fields, patch operations, and validation rules.Use this endpoint to programmatically discover the configuration for a specific note type.
        /// </summary>
