...
using System;
namespace Soenneker.ProductBoard.OpenApiClient.Notes.Item.Comments
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Comments.CommentsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CommentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/notes/{id}/comments", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Comments.CommentsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CommentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/notes/{id}/comments", rawUrl)
        {
        }
        /// <summary>
        /// Creates a comment on a note.The comment is attributed to the authenticated user and appears in the note&apos;sdiscussion thread, notifying the note&apos;s followers.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteComment201Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteComment201Response?> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteCommentRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteComment201Response> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteCommentRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteComment201Response>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteComment201Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a comment on a note.The comment is attributed to the authenticated user and appears in the note&apos;sdiscussion thread, notifying the note&apos;s followers.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteCommentRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteCommentRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Comments.CommentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Comments.CommentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Comments.CommentsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
