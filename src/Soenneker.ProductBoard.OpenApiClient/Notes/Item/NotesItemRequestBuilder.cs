...
using Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships;
...
namespace Soenneker.ProductBoard.OpenApiClient.Notes.Item
{
    ...
    public partial class NotesItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.RelationshipsRequestBuilder Relationships
        {
            get => new global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.RelationshipsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.NotesItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.NoteReferenceResponse?> PatchAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_updateNote body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.NoteReferenceResponse> PatchAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_updateNote body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_updateNote body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_updateNote body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.NotesItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.NotesItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves the full details of a specific note by its ID.&gt; Without the `members:pii:read` scope, owner and creator email fields are returned as `[redacted]`.By default, the response includes all non-null fields available in your workspace for that note type(e.g. `textNote`, `conversationNote`). You can optimize the response size by using the `fields` query parameter:- Use `fields=name,tags,content` to retrieve only specific fields- Use `fields=all` to include all fields, even those with null valuesYou can use this endpoint to display the entire note content, including metadata such as owner, tags, and relationships.&gt; Use the [`/v2/notes/configurations`](#/paths/~1v2~1notes~1configurations/get) endpointto discover which fields are available for your workspace.
        /// </summary>
