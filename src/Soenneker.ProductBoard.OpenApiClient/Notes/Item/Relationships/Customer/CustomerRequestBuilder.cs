...
namespace Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.Customer
{
    ...
    public partial class CustomerRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_replaceNoteCustomerRelationship_200_Response_application_json_2"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_replaceNoteCustomerRelationship_200_Response_application_json_2?> PutAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.C_notes_CustomerRelationshipReplaceRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_replaceNoteCustomerRelationship_200_Response_application_json_2> PutAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.C_notes_CustomerRelationshipReplaceRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_replaceNoteCustomerRelationship_200_Response_application_json_2>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Models.Notes_replaceNoteCustomerRelationship_200_Response_application_json_2.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Sets or replaces the customer relationship of a note.* A note can be linked to **one customer only** — either a User or a Company.* If a customer relationship already exists, it will be **replaced** with the new one provided.This is useful for attributing feedback to the correct user or company, especially when syncing notes from support systems or CRMs.&gt; To remove the customer relationship completely, use the `DELETE /v2/notes/{id}/relationships/customer/{targetId}` endpoint.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Soenneker.ProductBoard.OpenApiClient.Models.C_notes_CustomerRelationshipReplaceRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Soenneker.ProductBoard.OpenApiClient.Models.C_notes_CustomerRelationshipReplaceRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
