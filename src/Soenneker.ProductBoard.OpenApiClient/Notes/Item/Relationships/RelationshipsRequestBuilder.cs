...
namespace Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships
{
    ...
    public partial class RelationshipsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.ListNoteRelationships200Response"/></returns>
...
#nullable restore
        ...
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.ListNoteRelationships200Response> GetAsync(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.RelationshipsRequestBuilder.RelationshipsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Models.ListNoteRelationships200Response>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Models.ListNoteRelationships200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.CreateNoteRelationship201Response"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.CreateNoteRelationship201Response?> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.RelationshipRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.CreateNoteRelationship201Response> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.RelationshipRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Models.CreateNoteRelationship201Response>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Models.CreateNoteRelationship201Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves all relationships connected to a specific note.This includes:- Customer relationship (either a User or Company entity)- Product link relationships (e.g. linked features)### Customer relationship rules- A note can have a relationship to **exactly one customer entity** (User or Company).- If the note has a **User** as the customer, and that User is associated with a Company,  only the **User** is returned.- If the note has a **User** without a Company, the User is returned.- If the note has a **Company**, the Company is returned.- If the note has no customer relationship, an empty array is returned.### Product link relationships- Notes can be linked to **multiple Product Management entities** (e.g. features, components).- All such relationships are returned in the same response.&gt; To discover supported relationship types, use the [`/v2/notes/configurations`](#/paths/~1v2~1notes~1configurations/get) endpoint.
        /// </summary>
...
#nullable restore
            ...
            public global::Soenneker.ProductBoard.OpenApiClient.Models.ListNoteRelationshipsTargetTypeParameter? Targettype { get; set; }
            ...
            [QueryParameter("type")]
            public global::Soenneker.ProductBoard.OpenApiClient.Models.ListNoteRelationshipsTypeParameter? Type { get; set; }
        }
    }
}
