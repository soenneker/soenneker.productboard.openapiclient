...
using Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.Customer;
using Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships
{
    /// <summary>
    ...
    public partial class RelationshipsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.Customer.CustomerRequestBuilder Customer
        {
        ...
        public global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.Item.WithTargetTypeItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.Item.WithTargetTypeItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.RelationshipsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.RelationshipsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.RelationshipsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ProductBoard.OpenApiClient.Notes.Item.Relationships.RelationshipsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves all relationships connected to a specific note.This includes:- Customer relationship (either a User or Company entity)- Product link relationships (e.g. linked features)### Customer relationship rules- A note can have a relationship to **exactly one customer entity** (User or Company).- If the note has a **User** as the customer, and that User is associated with a Company,  only the **User** is returned.- If the note has a **User** without a Company, the User is returned.- If the note has a **Company**, the Company is returned.- If the note has no customer relationship, an empty array is returned.### Product link relationships- Notes can be linked to **multiple Product Management entities** (e.g. features, components).- All such relationships are returned in the same response.&gt; To discover supported relationship types, use the [`/v2/notes/configurations`](#/paths/~1v2~1notes~1configurations/get) endpoint.
        /// </summary>
