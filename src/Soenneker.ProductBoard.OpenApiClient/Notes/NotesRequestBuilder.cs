...
namespace Soenneker.ProductBoard.OpenApiClient.Notes
{
    ...
    public partial class NotesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 400 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 403 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 404 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 408 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 500 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.NotesListNotes200> GetAsync(Action<RequestConfiguration<global::Soenneker.ProductBoard.OpenApiClient.Notes.NotesRequestBuilder.NotesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "401", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "403", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "404", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "408", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
            };
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesNoteReferenceResponse_5"/></returns>
        ...
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 404 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 408 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 422 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6">When receiving a 500 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.NotesNoteReferenceResponse_5?> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.ProductBoard.OpenApiClient.Models.NotesNoteReferenceResponse_5> PostAsync(global::Soenneker.ProductBoard.OpenApiClient.Models.NotesCreateNoteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "404", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "408", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "422", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.ProductBoard.OpenApiClient.Models.NotesErrorResponse_6.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.ProductBoard.OpenApiClient.Models.NotesNoteReferenceResponse_5>(requestInfo, global::Soenneker.ProductBoard.OpenApiClient.Models.NotesNoteReferenceResponse_5.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &quot;Retrieves a list of notes from your workspace.&gt; Without the `members:pii:read` scope, owner and creator email fields are returned as `[redacted]`. Filtering by `owner[email]` or `creator[email]` requires the `members:pii:read` scope.- Notes are sorted by creation date, newest first.- You can filter results using query parameters like `archived`, `processed`, `owner[email]`, `creator[email]`, `metadata[source][system]`, `metadata[source][recordId]`, or date/time ranges.- Use the `pageCursor` parameter to paginate through results.- Use the `fields` query parameter to optimize response size (default: all non-null fields, use `fields=all` to include null values, or `fields=name,tags` for specific fields).&gt; To discover available fieldsuse the [`/v2/notes/configurations`](#/paths/~1v2~1notes~1configurations/get) endpoint.### Date/Time FilteringYou can filter notes by creation or update timestamps using ISO-8601 date-time format:- Use `createdFrom` and `createdTo` to filter by creation date (inclusive bounds)- Use `updatedFrom` and `updatedTo` to filter by update date (inclusive bounds)- All date/time filters can be combined with each other and with other filters- Date ranges must be valid (From &lt;= To) or a 400 error will be returned### Filtering combinationsSome combinations of the `archived` and `processed` flags result in empty or unexpected results.Use the following table to understand which notes are returned based on the filter values:| `archived` | `processed` | Result                    ||------------|-------------|---------------------------|| –          | –           | All notes                 || `true`     | `true`      | None                      || `true`     | `false`     | Archived                  || `false`    | `true`      | Processed                 || `false`    | `false`     | Unprocessed               || `true`     | –           | Archived                  || `false`    | –           | Processed + unprocessed   || –          | `true`      | Processed                 || –          | `false`     | Archived + unprocessed    |&gt; **Note**: Archived notes always return `processed: false` in the API response, regardless of their actual processing state. This is a known limitation of the system.&quot;
        /// </summary>
